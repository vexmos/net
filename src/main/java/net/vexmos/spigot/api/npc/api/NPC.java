...
package net.vexmos.spigot.api.npc.api;

import net.vexmos.spigot.api.npc.api.skin.Skin;
import net.vexmos.spigot.api.npc.api.state.NPCAnimation;
import net.vexmos.spigot.api.npc.api.state.NPCSlot;
import net.vexmos.spigot.api.npc.api.state.NPCState;
